<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="POEBudgetPlan.Login" %>
    ...
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="navbar-collapse" id="navbarContent">
                ...
                <a href="Register.aspx" class="btn btn-link" role="button">Register</a><span><a href="#">Login</a></span>
            </div>
        </nav>
        ...
        <div class="container">
            ...
            <div class="col-sm-10 col-sm-offset-1" style="margin-left: 290px">
                ...
                <div style="margin-top:20px; margin-left:15px">
                    <asp:Button ID="btnLogin" CssClass="btn btn-warning form-control col-sm-2" OnClick="btnLogin_Click" Text="Login" runat="server" />
